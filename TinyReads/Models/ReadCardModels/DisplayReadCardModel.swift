...
extension DisplayReadCard{
  ...
  static var onBoardingCard: [DisplayReadCard] {
	 let firstCard: ReadCardModel = ReadCardModel(id: "onboarding_save", translationGroupId: "", categoryId: "practice", subCategoryId: nil, languageCode: "", title: "Swipe right to save", hook: "Keep a tiny idea for later.\nYour archive becomes a quiet shelf of thoughts.", body: "", wordCount: 180, estimatedMinutes: 1, tags: [], sortIndex: 1, isActive: true)

	 let secondCard: ReadCardModel = ReadCardModel(id: "onboarding_skip", translationGroupId: "", categoryId: "practice", subCategoryId: nil, languageCode: "", title: "Swipe left to skip", hook: "Not every idea needs your time.\nMove past it and the next one appears.", body: "", wordCount: 150, estimatedMinutes: 1, tags: [], sortIndex: 2, isActive: true)
